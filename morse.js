...
const MorseCode = {
  ...
  test: () => {
    console.log('testando o enconding de string:');
    console.log('apenas um teste');
    mc = MorseCode.encode.call(this, 'apenas um teste');
    console.log('Encoding retornado: ' + mc);
    console.log('Testando o decoding:');
    console.log(mc);
    pt = MorseCode.decode.call(this, mc);
    console.log('Decoding retornado: ' + pt)
